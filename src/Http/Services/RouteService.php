...
abstract class RouteService implements WpHooksInterface
{
    ...
    const string NONCE_ACTION = 'wp_rest';
     ...
     * @param array $args
     */
    protected static function registerRestRoute(
        string $namespace,
        string $route,
        $callback,
        string $method,
    ...
    abstract public function initializeRoute(): void;
     ...
     */
    abstract protected function registerRoute(string $namespace, string $route, $callback): void;
}
